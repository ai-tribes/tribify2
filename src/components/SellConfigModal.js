...
const SellConfigModal = ({ onClose, onComplete }) => {
  ...
  return (
    <div className="modal-container">
      ...
      <div className="modal-content sell-config-modal">
        ...
        <div className="settings-summary">
          <p>
            Will automatically sell random amounts between {settings.minAmount} and {settings.maxAmount} SOL
            using {settings.walletCount} wallet{settings.walletCount > 1 ? 's' : ''}
          </p>
          <p>
            Sells will occur between {settings.startTime || '(not set)'} and {settings.endTime || '(not set)'}
          </p>
          <p>
        ...
        <div className="button-group">
          ...
          <button className="start-button">Start Selling</button>
        </div>
      </div>
    </div>
  );
...
export default SellConfigModal; 